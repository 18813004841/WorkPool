...
namespace UnityEngine.UI
{
    ...
    [AddComponentMenu("UI/Custom/Image", 1)]
    public class CustomImage : CustomMaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
        /// <summary>
        ...
        private static void TrackImage(CustomImage g)
        {
            if (!s_Initialized)
            {
        ...
        private static void UnTrackImage(CustomImage g)
        {
